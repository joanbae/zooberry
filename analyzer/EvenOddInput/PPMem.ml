...
let print_zparity zparity =
  let print_zparity' = function
    | Zparity.Zparity.Bot -> print_string "Bot"
    | Zparity.Zparity.Top -> print_string "Top"
    | Zparity.Zparity.Odd -> print_string "Odd"
    | Zparity.Zparity.Even -> print_string "Even" in
  open_box 0;
  print_zparity' zparity;
  close_box ()
